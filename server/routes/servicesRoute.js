...
router.put('/diagnostics/editDiagnostics/:diagnosticsId', diagnosticsController.editDiagnostics);
...
router.put('/repairs/editRepair/:repairId', repairsController.editRepair);
...
router.put('/maintenances/editMaintenance/:maintenanceId', maintenancesController.editMaintenance);
